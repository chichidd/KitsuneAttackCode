...
def getStats(nstat, srcMAC, dstMAC, srcIP, srcProtocol, dstIP, dstProtocol, datagramSize, timestamp):
    ...
    Possible exception: KeyError. Because some keys are not in dictionary HT of nstat objects. Since this kind of exception rarely occurs, we omit KeyError with "try except" clause. 
    '''
    res = []
